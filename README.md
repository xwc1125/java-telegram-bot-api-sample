# Java Telegram Bot API Sample

Java sample for interacting with [Java Telegram Bot API](https://github.com/xwc1125/java-telegram-bot-api.git)
...
Send game use inlineKeyboardMarkup
...
//      new InlineKeyboardButton("callback_data").callbackData("{" +"game_short_name: " + gameShortName + "}"),
